...
from .routes import auth_routes, department_routes, doctor_routes, patient_routes, document_routes, stats_routes, notes_routes, doctor_dashboard_routes, prescription_routes, ehr_routes, soap_routes, diagnosis_routes, appointment_routes, ot_routes, vitals_routes
